...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/search_text_field.svg
  SvgGenImage get searchTextField =>
      const SvgGenImage('assets/icons/search_text_field.svg');

  /// List of all assets
  List<SvgGenImage> get values => [home, save, search, searchTextField];
}
